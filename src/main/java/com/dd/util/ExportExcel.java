...
public class ExportExcel<T> {
    ...
    public void exportExcel(Collection<T> dataset, OutputStream out) {
        ...
        exportExcel(XLS_TITLE, null, dataset, out, DATE_PATTERN);
    ...
    public void exportExcel(String[] headers, Collection<T> dataset,
        ...
        exportExcel(XLS_TITLE, headers, dataset, out, DATE_PATTERN);
    ...
    public void exportExcel(String[] headers, Collection<T> dataset,
        ...
        exportExcel(XLS_TITLE, headers, dataset, out, pattern);
    ...
    public void exportExcel(String title, String[] headers,
        ...
        exportExcel(title, headers, dataset, out, DATE_PATTERN);
    }
            ...
            for (short i = 0; i < fields.length; i++) {
                ...
                try {
                    ...
                    if (value instanceof Double) {
                        ...
                        textValue = bigDecimal.toPlainString();
