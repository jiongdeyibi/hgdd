...
import com.dd.exception.DataParseException;
...
public final class TypeParseUtil {
    ...
    public static final Object convert(Object value, Class<?> type, String format, Class model) {
        return convert(value, type.getName(), format, model);
    }
     ...
     * @throws DataParseException
     */
    public static final Object convert(Object value, String type, String format, Class model) {
        Locale locale = Locale.getDefault();
        if (value == null) {
            return null;
        } else if ("java.util.List".equals(type)) {
            List valueList = JSON.parseArray(value.toString(), model);
            return valueList;
    ...
    public static final Boolean convertToBoolean(Object obj) {
        return (Boolean) convert(obj, "Boolean", null, null);
    }
    ...
    public static final Integer convertToInteger(Object obj) {
        return (Integer) convert(obj, "Integer", null, null);
    }
    ...
    public static final String convertToString(Object obj) {
        return (String) convert(obj, "String", null, null);
    }
    ...
    public static final String convertToString(Object obj, String defaultValue) {
        Object s = convert(obj, "String", null, null);
        if (s != null) {
            return (String) s;
        } else {
            return "";
    ...
    public static final Long convertToLong(Object obj) {
        return (Long) convert(obj, "Long", null, null);
    }
    ...
    public static final Double convertToDouble(Object obj) {
        return (Double) convert(obj, "Double", null, null);
    }
    ...
    public static final Double convertToFloat(Object obj) {
        return (Double) convert(obj, "Float", null, null);
    }
    ...
    public static final BigDecimal convertToBigDecimal(Object obj, int scale) {
        return ((BigDecimal) convert(obj, "BigDecimal", null, null)).setScale(scale, 5);
    }
    ...
    public static final java.util.Date convertToDate(Object obj, String format) {
        return (java.util.Date) convert(obj, "Date", format, null);
    }
    ...
    public static final Date convertToSqlDate(Object obj, String format) {
        return (Date) convert(obj, "java.sql.Date", format, null);
    }
    ...
    public static final Timestamp convertToTimestamp(Object obj, String format) {
        return (Timestamp) convert(obj, "Timestamp", format, null);
    }
}
